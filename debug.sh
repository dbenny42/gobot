...
export DP_ITR_DETAIL=$((1<<5))
export GBC_DETAIL=$((1<<6))
export BOARD_DETAIL=$((1<<10))
export ALL_DETAIL=$(($UCT_DETAIL|$BP_DETAIL|$TP_DETAIL|$DP_DETAIL|$TP_ITR_DETAIL|$DP_ITR_DETAIL|$GBC_DETAIL|$BOARD_DETAIL))
